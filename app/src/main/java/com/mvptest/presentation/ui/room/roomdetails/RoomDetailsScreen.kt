...
//                    }
            ...
            Column(
                ...
                TextMediumBlack14sp(
                    modifier = Modifier.padding(top = 5.dp),
                    text = if (state.value.roomDetails?.airExchangePerformance != "") {
                        state.value.roomDetails?.airExchangePerformance.toString() + " " + stringResource(
                            id = R.string.m3,
                        )
                    } else {
                        ""
                ...
                TextMediumBlack14sp(
                    ...
                    text = if (state.value.roomDetails?.pressureLoss != "") {
                        state.value.roomDetails?.pressureLoss.toString() + " " + stringResource(
                            id = R.string.pa,
                        )
                    } else {
                        ""
                ...
                if (state.value.roomDetails?.ventSystemDestination != VentSystemDestination.EXHAUST) {
                    ...
                    TextMediumBlack14sp(
                        modifier = Modifier.padding(top = 5.dp),
                        text = if (state.value.roomDetails?.heaterPerformance != "") {
                            state.value.roomDetails?.heaterPerformance.toString() + " " + stringResource(
                                id = R.string.kvt,
                            )
                        } else {
                            ""
                    ...
                    if (state.value.roomDetails?.isAirConditioner == true) {
                        ...
                        TextMediumBlack14sp(
                            ...
                            text = if (state.value.roomDetails?.airConditionerPerformance != "") {
                                state.value.roomDetails?.airConditionerPerformance.toString() + " " + stringResource(
                                    id = R.string.kvt,
                                )
                            } else {
                                ""
